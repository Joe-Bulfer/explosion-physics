/*
gcc collision-bouncy-ball.c -o collision-bouncy-ball -I ../../../projects/raylib-quickstart/build/external/raylib-master/src/ -L ../../../projects/raylib-quickstart/bin/Debug/ -lraylib -lm -lpthread -ldl -lX11 && ./collision-bouncy-ball

below plus raylib-boilerplate

gcc $FILENAME.c -o $FILENAME -I $SRC -L $DEBUG -lraylib -lm -lpthread -ldl -lX11 && ./FILENAME
*/
#include "raylib.h"
#include "raymath.h"
